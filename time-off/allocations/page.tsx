  ...
  return (
    <div>
      <div className="view-head">
        <div>
          <h2>Time off allocations</h2>
          <p className="sub">
            Employee leave balances. An allocation must be approved before it's available to spend.
          </p>
        </div>
      </div>
      <div className="card">
        <Table
          columns={[
            ...
            { header: "Remaining", render: (a) => a.allocated - a.taken, num: true },
